...
// import dataIndex from './delete/spamJson.json'
import dataIndex from './data/spamJson.json';
  ...
  constructor(props){
    ...
    getAction =(e)=>{
      ...
      if(this.state.checkboxValue==0){
       ...
       axios.post('http://127.0.0.1:3001/spam', 
        { 
    ...
    componentDidMount() {
      axios.get(`http://127.0.0.1:3001/spam`)
      .then(res => {
